            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-header text-white text-center py-4" style="background-color: #39A900; border-bottom: none;">
                        <h4 class="mb-0 fw-bold">Detalle de la Ficha</h4>
                        <p class="mb-0 mt-1 small opacity-75">{{ $cohorts['code'] }}</p>
                    </div>
                    
                    <div class="card-body p-4 p-md-5 bg-white">
                        
                        <div class="mb-4">
                            <span class="text-muted small d-block mb-1 fw-bold text-uppercase tracking-wider">ID de Ficha</span>
                        ...
                        <div class="mb-4">
                            <span class="text-muted small d-block mb-1 fw-bold text-uppercase tracking-wider">Numero de ficha</span>
                        ...
                        <div class="mb-4">
                            <span class="text-muted small d-block mb-1 fw-bold text-uppercase tracking-wider">Fecha de inicio</span>
                        ...
                        <div class="mb-4">
                            <span class="text-muted small d-block mb-1 fw-bold text-uppercase tracking-wider">Cronograma</span>
                            <div class="p-3 bg-light rounded-3 text-dark">
                                {{ $cohorts['schedule'] }}
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                <span class="text-muted small d-block mb-1 fw-bold text-uppercase tracking-wider">ID de la oferta</span>
