                    ...
                    <table id="idprogram" class="table table-hover align-middle mb-0" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($program->urlFoto)
                                    <a href="#modalFoto{{ $program->id }}" data-bs-toggle="modal" class="d-inline-block text-decoration-none" title="Clic para ampliar">
                                    ...
                                    <div class="modal fade" id="modalFoto{{ $program->id }}" tabindex="-1" aria-labelledby="modalFotoLabel{{ $program->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
                                                <div class="modal-header text-white" style="background-color: #39A900;">
                                                    <h5 class="modal-title fw-bold" id="modalFotoLabel{{ $program->id }}">
                                                        <i class="bi bi-image me-2"></i>{{ $program->name }}
                                                    </h5>
                                                ...
                                                <div class="modal-footer bg-white border-top-0 d-flex justify-content-between">
                                                    <span class="text-muted small">Código ID: #{{ $program->id }}</span>
