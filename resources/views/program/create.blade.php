            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-header text-white text-center py-4" style="background-color: #39A900; border-bottom: none;">
                        <h4 class="mb-0 fw-bold">Registrar Programa</h4>
                        <p class="mb-0 mt-1 small opacity-75">Ingrese los datos del programa</p>
                    </div>

                    <div class="card-body p-4 p-md-5 bg-white">
                        <form action="{{ route('program.admin') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-floating mb-4">
                                <select name="type" id="type" class="form-select" required>
                                    ...
                                    <option value="Especializacion">Especialización Tecnologica</option>
                                    <option value="Curso">Curso Especial</option>
                                </select>
                                <label for="type" class="text-secondary">Tipo de Formación</label>
                            </div>
                            ...
                            <div class="form-floating mb-4">
                                <input type="text"
                                    ...
                                    id="duration"
                                    name="duration"
                                    placeholder="Duracion del programa"
                                    required>
                                <label for="duration" class="text-secondary">Duración</label>
                            </div>

                            <div class="form-floating mb-4">
                                <select name="area_id" id="program_area_id" class="form-select" required>
                            ...
                            <div class="mb-4">
                                <label for="urlFoto" class="form-label fw-bold text-secondary mb-1">Fotografía del Programa</label>
                ...
                <a href="{{ route('program.index') }}" class="btn text-white fw-bold px-4 py-2 shadow-sm d-inline-flex align-items-center gap-2" style="background-color: #39A900;">
                    Revisar Registros
                </a>
            </div>
